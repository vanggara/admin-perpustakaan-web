                      ...
                      <section class="wrapper">
                          ...
                          <div class="row">
                            ...
                            <div class="col-sm-10">
                              <input required type="text" onkeypress="return isNumberKey(event)"
                                class="form-control round-form" name="isbn_number" value="<?php echo $key->isbn?>">
                            </div>
                          </div>
                        </div>
                        <!-- /form group -->
                          ...
                          <div class="row">
                            ...
                            <div class="col-sm-10">
                              <input required type="text" class="form-control round-form"
                                onkeypress="return isNumberKey(event)" name="tahun" value="<?php echo $key->tahun?>">
                            </div>
                          </div>
                        </div>
                        <!-- /form group -->
                        <div class="form-group">
                          <div class="row">
                            ...
                            <div class="col-sm-10">
                              <input required type="text" onkeypress="return isNumberKey(event)"
                                class="form-control round-form" name="jumlah" value="<?php echo $key->jumlah?>">
                            </div>
                          </div>
                        </div>
                        <!-- /form group -->

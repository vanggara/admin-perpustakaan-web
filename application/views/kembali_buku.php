          ...
          <div class="row">
            ...
            <div class="col-xl-12 col-lg-7">
              <div class="card shadow mb-4">
                ...
                <form action="<?php echo base_url();?>crud/action_pengembalian_buku/<?php echo $key->id ?>"
                  method="post">
                  <div class="card-body">
                    <!--main content start-->
                      ...
                      <section class="wrapper">
                        ...
                        <div class="form-group">
                          <div class="row">
                            ...
                            <div class="col-sm-10">
                              <input type="text" class="form-control round-form" name="id_peminjam"
                                value=<?php echo $key->id_peminjam?> readonly>
                            </div>
                          </div>
                        </div>
                        <!-- /form group -->
                        <div class="form-group">
                          <div class="row">
                            ...
                            <div class="col-sm-10">
                              <input type="text" class="form-control round-form" name="nama_peminjam"
                                value=<?php echo $key->nama_peminjam?> readonly>
                            </div>
                          </div>
                        </div>
                        <!-- /form group -->
                          ...
                          <div class="row">
                            ...
                            <div class="col-sm-10">
                              <input type="text" class="form-control round-form" name="isbn_buku"
                                value=<?php echo $key->isbn_buku?> readonly>
                            </div>
                          </div>
                        </div>
                        <!-- /form group -->
                      ...
                      ?>
                        ...
                        <div class="form-group">
                          <div class="row">
                            ...
                            <div class="col-sm-10">
                              <input type="date" class="form-control" value=<?php echo $key->date_kembali?> readonly
                                name="date_pinjam"></p>
                            </div>
                          </div>
                          <!-- /form group -->
                            ...
                            <div class="row">
                              ...
                              <div class="col-sm-10">
                                <input type="date" class="form-control round-form"
                                  value="<?php echo date('Y-m-d', strtotime(date('m/d/y'))); ?>" readonly
                                  name="date_kembali">
                              </div>
                            </div>
                          </div>
                      ...
                      ?>
                          ...
                          <div class="form-group">
                            <div class="row">
                              ...
                              <div class="col-sm-10">
                                <input type="text" class="form-control round-form" value=<?php echo $telat?>
                                  name="telat" id="telat" onkeyup="sum();" readonly>
                              </div>
                            </div>
                          </div>
                          <!-- /form group -->
                            ...
                            <div class="row">
                              ...
                              <div class="col-sm-10">
                                <input required onkeypress="return isNumberKey(event)" type="text"
                                  class="form-control round-form" name="denda" id="denda" onkeyup="sum();">
                              </div>
                            </div>
                          </div>
                          <!-- /form group -->
                          <div class="form-group">
                            <div class="row">
                              ...
                              <div class="col-sm-10">
                                <input required type="text" class="form-control round-form" name="total" id="total"
                                  readonly>
                              </div>
                            </div>
                          </div>

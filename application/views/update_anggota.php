                    ...
                    <section id="main-content">
                      <section class="wrapper">
                          ...
                          <div class="row">
                            ...
                            <div class="col-sm-10">
                              <input required onkeypress="return isNumberKey(event)" type="text"
                                class="form-control round-form" name="id" value="<?php echo $key->id?>">
                            </div>
                          </div>
                        </div>
                        <!-- /form group -->
                          ...
                          <div class="row">
                            ...
                            <div class="col-sm-10">
                              <input required type="text" class="form-control round-form" name="tempat_lahir"
                                value="<?php echo $key->tempat_lahir?>">
                            </div>
                          </div>
                        </div>
                        <!-- /form group -->
                          ...
                          <div class="row">
                            ...
                            <div class="col-sm-10">
                              <input required type="date" class="form-control round-form" name="tanggal_lahir"
                                value="<?php echo $key->tanggal_lahir?>">
                            </div>
                          </div>
                        </div>
                        <!-- /form group -->
                        <div class="showback">
                          ...
                          <button type="submit" class="btn btn-round btn-danger" value="cancel" name="cancel"

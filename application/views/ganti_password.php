                      ...
                      <section class="wrapper">
                        ...
                        <div class="form-group">
                          <div class="row">
                            ...
                            <div class="col-sm-10">
                              <input required type="password" class="form-control round-form" id="password_baru"
                                name="password_baru" onkeyup="keydownFunction()">
                            </div>
                          </div>
                        </div>
                        <!-- /form group -->
                        <div class="form-group">
                          <div class="row">
                            ...
                            <div class="col-sm-10">
                              <input required type="password" class="form-control round-form"
